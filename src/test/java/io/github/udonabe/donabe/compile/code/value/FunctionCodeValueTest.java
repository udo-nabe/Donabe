...
public class FunctionCodeValueTest {
    ...
    public void testType() {
        assertEquals(
                new FunctionCodeValue("test", List.of(), Set.of(), new CodeSection(List.of())).type(),
    ...
    public void testContent() {
        assertArrayEquals(
                new byte[]{
                    ...
                    0x00, 0x00, 0x00, 0x00, //引数スロットの個数(引数無し)
                    0x00, 0x00, 0x00, 0x00, //ローカル変数の個数(無し)
                    0x00, 0x00, 0x00, 0x00, //コードの長さ(無し)
                },
                new FunctionCodeValue("test", List.of(), Set.of(), new CodeSection(List.of())).content());
        ...
        assertArrayEquals(
                new byte[]{
                    ...
                    0x02, 0x00, 0x00, 0x00, //引数スロットの個数
                    0x00, 0x00, 0x00, 0x00, //引数スロット1
                    0x01, 0x00, 0x00, 0x00, //引数スロット2

                    0x02, 0x00, 0x00, 0x00, //ローカル変数の個数
